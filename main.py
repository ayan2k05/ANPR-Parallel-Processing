...
ocrs = {}
CORRECTIONS = {
    "MB": "WB", "W8": "WB", "18": "WB", "IB": "WB",
    "0D": "OD", "DD": "OD", "CD": "OD", "H8": "HR",
    "G7": "GJ", "K4": "KA", "R7": "RJ", "R1": "RJ",
    "U9": "UP", "C6": "CG", "T5": "TS"
}
...
def distribute_work(image_paths, num_gpus):
    ...
    for i in range(num_gpus):
        ...
        if i == num_gpus - 1:  # Last chunk gets remaining images
...
def main():
    ...
    if device_count <= 1:
        ...
        # Use ThreadPoolExecutor for GPU coordination
